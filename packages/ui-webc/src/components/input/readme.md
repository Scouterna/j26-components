...
| `icon`              | `icon`        | URL of an SVG icon to display inside the leading edge of the input. Import the SVG as a URL and pass it here, e.g. `import searchIcon from "@tabler/icons/outline/search.svg"`.                              | `string`                                                                                             | `undefined` |
